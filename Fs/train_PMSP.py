...
if __name__=="__main__":
    ...
    PMSP=PMSPScheduler(num_machines=6, initial_jobs=3, additional_jobs=3, additional_arrivals=31, processing_time_range=(10, 20), machine_speed=[1,1,1,1.5,1.5,1.5], sim_type=1, start_additional_arrival=20, arrival_interval=10,setup_range=(5,15),family_setup_num=4)
