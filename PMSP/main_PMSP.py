...
if __name__=="__main__":
    ...
    device='cuda'
    ppo=PPO(learning_rate=0.001, clipping_ratio=0.2, job_len=130,machine_len=12, d_model=256, num_heads=4, fea_len=6,num_layers=2,dim_feedforward=256).to(device)
