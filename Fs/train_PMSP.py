...
if __name__=="__main__":
    ...
    PMSP=PMSPScheduler(num_machines=6, initial_jobs=12, additional_jobs=12, additional_arrivals=5, processing_time_range=(10, 20), machine_speed=[1,1,1,1.5,1.5,1.5], sim_type=1, start_additional_arrival=40, arrival_interval=40,setup_range=(5,15),family_setup_num=4)
