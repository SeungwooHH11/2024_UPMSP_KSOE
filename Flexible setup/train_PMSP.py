...
if __name__=="__main__":
    ...
    PMSP=PMSPScheduler(10,100,20,20,(10,20),[1,1,1,1,1,1.5,1.5,1.5,1.5,1.5],1,60,60,(5,15),10)
    #pr=PMSPScheduler(10,0,20,25,(10,20),[1,1,1,1,1,1.5,1.5,1.5,1.5,1.5],1,0,60,(5,15),10)
    #pr=PMSPScheduler(10,200,20,15,(10,20),[1,1,1,1,1,1.5,1.5,1.5,1.5,1.5],1,60,60,(5,15),10)
    ppo=PPO(learning_rate=0.001, clipping_ratio=0.2, machine_len=10, d_model=512, num_heads=8, fea_len=25,num_layers=3,dim_feedforward=1024).to(device)
    ...
    validation_history=np.zeros((int(1501/validation_step)+10,number_of_validation))
    ...
    for e,priority in enumerate(mode_list):
        ...
        for j in range(number_of_validation):
            ...
            for k in range(number_of_validation_batch):
                ...
                episode=[]
                machines,jobss,start_times,durations,episode,total_tardy,total_reward=PMSP.schedule_jobs(jobs,setup,episode,ppo)
