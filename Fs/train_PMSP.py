...
if __name__=="__main__":
    ...
    PMSP=PMSPScheduler(num_machines=6, initial_jobs=24, additional_jobs=24, additional_arrivals=3, processing_time_range=(10, 20), machine_speed=[1,1,1,1.5,1.5,1.5], sim_type=1, start_additional_arrival=70, arrival_interval=70,setup_range=(5,15),family_setup_num=4)
    ...
    for i in range(number_of_iteration):
        ...
        history[i,0]=ave_r
        vessl.log(step=i, payload={'train_reward': ave_r})
