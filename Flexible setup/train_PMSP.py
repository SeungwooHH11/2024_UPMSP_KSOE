...
if __name__=="__main__":
    ...
    number_of_iteration=int(1500/number_of_trial)  # 전체 iteration #iteration 단위로 문제 변화
    validation=[]
    validation_step = 100
    num_of_meta=6
    history = np.zeros((number_of_iteration * number_of_trial,2))
    validation_history=np.zeros((int(1500/validation_step)+10,number_of_validation))
